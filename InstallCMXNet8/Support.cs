...
namespace InstallCMX
{
    ...
    public class Support : IDisposable
    {
        ...
        public static void PressChooseOrCtrlC() => Console.WriteLine( ChooseOrCtrlC );
        ...
        public void InitLogging()
        {
            ...
            try
            {
                ...
                System.Diagnostics.Trace.Listeners.Add( ThisListener );  // Used for messages under the conditions of the Switch: None, Error, Warning, Information, Verbose
            ...
            NormalMessageToConsole = GetInstallCMXIniValue( "InstallCMX", "NormalMessageToConsole", "true" ).Equals( "true", StringComparison.OrdinalIgnoreCase );   // Verbose, Information, Warning, Error, Off
